...
cards = [
    ...
    (9, "🎯", "Top Picks", "Piatka miesiaca z SP500 i GPW — regula momentum, limit sektorowy, track record", "pages/9_top_picks.py"),
    (10, "🪙", "Kryptowaluty", "Top 200 kryptowalut — ranking, alt/BTC ratio, backtest", "pages/10_kryptowaluty.py"),
    (11, "🏗️", "Portfolio Builder", "Zbuduj portfel, ustaw wagi, backtest i analiza korelacji", "pages/11_portfolio.py"),
    (12, "🔎", "Screener", "Cross-asset ranking momentum ze wszystkich klas aktywow", "pages/12_screener.py"),
    (13, "🌍", "Makro Dashboard", "VIX, yield curve, DXY, S&P+200MA, zloto, ropa", "pages/13_makro.py"),
    (14, "📅", "Sezonowosc", "Heatmapa miesięcznych zwrotow, wzorce sezonowe, Sell in May", "pages/14_sezonowosc.py"),
    (15, "💱", "Waluta PLN/USD", "Wplyw kursu USD/PLN na zwroty ETF-ow", "pages/15_waluta.py"),
    (16, "📉", "Drawdowny", "Analiza spadkow od szczytu, czas trwania i odbudowy", "pages/16_drawdown.py"),
    (17, "🚦", "Historia Sygnalow", "Pelna historia zmian sygnalu GEM w czasie", "pages/17_sygnaly.py"),
    (18, "🎲", "Monte Carlo", "Symulacja przyszlych zwrotow — ile mozesz miec za N lat?", "pages/18_monte_carlo.py"),
    (19, "🔄", "Rotacja Sektorowa", "Ktory sektor GICS prowadzi? Heatmapa momentum sektorow", "pages/19_sektory.py"),
    (20, "🔗", "Intermarket", "Relacje miedzy klasami aktywow: akcje, obligacje, zloto, dolar", "pages/20_intermarket.py"),
    (21, "🔀", "Side-by-Side", "Porownaj dwa aktywa obok siebie — cena, drawdown, RS", "pages/21_side_by_side.py"),
    (22, "🚀", "GEM Extended", "Backtest GEM z dowolnym universe (do 10 ETF + krypto), top N equal-weight", "pages/22_gem_extended.py"),
    (23, "📅", "Earnings Calendar", "Kalendarz nadchodzacych raportow SP500+GPW (±28 dni) z watchlist i cross-link do F13", "pages/23_earnings_calendar.py"),
    (24, "👥", "Insider Screener", "Bulk insider screener SP500 — kto kupuje, kto sprzedaje, sektorowa heatmapa, cross-link do F13", "pages/24_insider_screener.py"),
]
