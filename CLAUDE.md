...
## Overview
Polish-language Streamlit dashboard for ETF analysis using Gary Antonacci's Global Equity Momentum (GEM) strategy. Analyzes 37 ETFs globally + 140 Polish stocks from GPW (WIG20/mWIG40/sWIG80) + ~200 cryptocurrencies + ~456 US stocks from S&P 500. 21 pages total.
...
pages/
  ...
  21_gem_extended.py    # GEM Extended (configurable universe + top N + safe asset fallback)
